...
export const messagesEn: Record<string, string> = {
	...
	'settings.appearance.themeEditorTitle': 'Dark theme',
	'settings.appearance.themeEditorDesc': 'Fine-tune the active palette so the app feels much closer to the reference layout.',
	'settings.appearance.copyTheme': 'Copy theme',
	'settings.appearance.copiedTheme': 'Copied',
