...
export const messagesZhCN: Record<string, string> = {
	...
	'settings.appearance.themeEditorTitle': '深色主题',
	'settings.appearance.themeEditorDesc': '微调当前主题配色，让外观更接近参考图的感觉。',
	'settings.appearance.copyTheme': '复制主题',
	'settings.appearance.copiedTheme': '已复制',
